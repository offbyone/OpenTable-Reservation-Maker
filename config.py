...
MIN_DATE = 10  # For debugging, so I dont book a reservation for tonight that I can't cancel
RESERVATION_FILENAME = 'RESERVATION_DETAILS.json'  # Make this an empty string to not save locally
